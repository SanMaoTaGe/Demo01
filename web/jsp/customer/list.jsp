...
<FORM id="customerForm" name="customerForm"
      action="${pageContext.request.contextPath }/customer_findByPage.action" method=post>
                    ...
                    <TR>
                        <TD height=25>
                            <TABLE cellSpacing=0 cellPadding=2 border=0>
                                ...
                                <TR>
                                    <TD>客户名称：</TD>
                                    <TD><INPUT class=textbox id=sChannel2 style="WIDTH: 60px;height:15px" maxLength=50
                                               name="custName"></TD>
                                    <TD>客户来源：</TD>
                                    <TD>
                                        <select name="cust_industry.dict_id" class=textbox id="cust_source"
                                    ...
                                    <TD>客户行业：</TD>
                                    <TD>
                                        <select name="cust_source.dict_id" class=textbox id="cust_industry"
                                                style="WIDTH: 90px;height:15px">
                                            <option value="">---请选择---</option>
                                        </select>
                                    </TD>
                                    <TD>客户级别：</TD>
                                    <TD>
                                        <select name="cust_level.dict_id" class=textbox id="cust_level"
                                                style="WIDTH: 90px;height:15px">
                                            <option value="">---请选择---</option>
                                        </select>
                                    </TD>
                                    <TD>客户电话：</TD>
                                    <TD><INPUT class=textbox id=sChannel3 style="WIDTH: 80px" maxLength=50 name="cust_phone"></TD>
                            ...
                            <SPAN id=pagelink>
                                <DIV style="LINE-HEIGHT: 20px; HEIGHT: 20px; TEXT-ALIGN: right">
                                    ...
                                    <select name="pageSize" onchange="changePageSize()">
                                        ...
                                        <option value="15"
                                                <c:if test="${pageSize==15 }">selected</c:if>>15</option>
                                        <option value="20"
