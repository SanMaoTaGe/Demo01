    ...
    <script type="text/javascript">
        ...
        function ajax() {
           ...
           /*var url="${pageContext.request.contextPath}/baseDict_findByType";*/
            ...
            $.getJSON("${pageContext.request.contextPath}/baseDict_findByType",{type:"001"},function (result) {
                a
            })
        }
                ...
                <TABLE cellSpacing=0 cellPadding=5 border=0>
                    <TR>
                       ...
                       <s:textfield class="textbox" id="sChannel2" style="WIDTH: 180px" maxLength="50" name="cust_name"></s:textfield>
                        ...
                        <td>所属行业 ：</td>
                        <td>
                            <select name="cust_industry.dict_id" class=textbox id="cust_industry"
                    ...
                    <TR>
                        <td>客户资质：</td>
                        <td >
                            <INPUT class=button id=sButton2 type="file" name="upload">
                        </td>
                    </TR>
                    <tr>
                        <td rowspan=2>
