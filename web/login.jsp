    ...
    <DIV id=UpdatePanel1>
        ...
        <DIV>
            <TABLE cellSpacing=0 cellPadding=0 width=900 align=center border=0>
                <TBODY>
                <TR>
                    <TD style="HEIGHT: 105px"><IMG src="${pageContext.request.contextPath}/images/login_1.gif" border=0>
                    </TD>
                </TR>
                <TR>
                                ...
                                <TD>
                                    <TABLE cellSpacing=0 cellPadding=2 border=0>
                                        ...
                                        <TR>
                                            ...
                                            <TD style="HEIGHT: 28px"><INPUT id=txtPwd style="WIDTH: 130px" type=password
                                        ...
                                        <TR>
                                            ...
                                            <TD style="HEIGHT: 28px"><INPUT id=txtcode style="WIDTH: 130px"
                                                                            name=txtcode></TD>
